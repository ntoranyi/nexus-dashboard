# Règles de montage du projet — À LIRE EN PREMIER

Avant tout montage ou modification de composition, lire `shopify-produits-style.md` (dans ce dossier) et appliquer ses règles.
Quand l'utilisateur dit « garde ça en mémoire », ajouter la règle dans la bonne section de `shopify-produits-style.md` (datée, une ligne), puis committer.
