...
Avant tout montage ou modification de composition, lire `nexus-ai-style.md` (dans ce dossier) et appliquer ses règles.
Quand l'utilisateur dit « garde ça en mémoire », ajouter la règle dans la bonne section de `nexus-ai-style.md` (datée, une ligne), puis committer.
